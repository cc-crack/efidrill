...
class PluginMgr():
    ...
    def load_plugins(self,rd_analysis):
        ...
        for m in module_files:
            ...
            if module is None:
                ...
                self.plugins[module.PLUGIN_CLASS.__name__] = module.PLUGIN_CLASS(rd_analysis)
    ...
    def callplugin_on_add_interesting_memory_map_list(self,fuc, def_var, use_list, is_alias, default_value):
        for p in self.plugins.values():
            p.add_interesting_memory_map_list(fuc, def_var, use_list, is_alias, default_value)
